...
import { GameController, Eye, EyeSlash, Key, User } from '@phosphor-icons/react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-cobalt-blue/40 to-gray-900 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-gray-800 rounded-xl shadow-2xl overflow-hidden border border-gray-700">
          {/* Header */}
          <div className="bg-gradient-to-r from-cobalt-blue to-neon-purple/60 p-4 text-center">
            <div className="flex items-center justify-center gap-3">
              <GameController className="w-8 h-8" weight="fill" />
              <h1 className="text-2xl font-bold">LOG IN YOUR ACCOUNT</h1>
            </div>
            <p className="text-sm mt-1 opacity-90">Join the competitive community</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-cobalt-blue to-neon-purple/60 hover:from-cobalt-blue/90 hover:to-purple-600/90 text-white font-medium py-3 px-4 rounded-lg transition-all flex items-center justify-center gap-2 disabled:opacity-70"
            >
              {isLoading ? (
                <>
          ...
          <div className="px-6 pb-6 pt-2 text-center">
            <p className="text-gray-400 text-sm">
              ...
              <Link href="/auth/signup" className="text-neon-blue hover:underline font-medium">
                Sign Up
              </Link>
            </p>
          </div>
        ...
        <div className="mt-6 text-center">
          <div className="relative flex items-center py-4">
            ...
            <span className="flex-shrink mx-4 text-gray-400 text-sm">SIGN IN WITH</span>
            <div className="flex-grow border-t border-gray-700"></div>
          </div>
